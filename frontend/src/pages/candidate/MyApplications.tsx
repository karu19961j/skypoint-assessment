              ...
              {apps.map((a) => (
                <tr key={a.id}>
                  <td className="px-4 py-3">
                    {a.job ? (
                      <Link to={`/jobs/${a.job.id}`} className="font-medium text-slate-900 hover:text-brand-700">
                        {a.job.title}
                      </Link>
                    ) : (
                  ...
                  <td className="px-4 py-3 text-right">
                    {a.stage === "applied" ? (
                      <button onClick={() => withdraw(a.id)} className="text-xs text-rose-600 hover:underline">
                        Withdraw
                      </button>
                    ) : null}
                  </td>
